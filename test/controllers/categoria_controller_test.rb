...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post categoria_url, params: { categorium: { nombre: @categorium.nombre, numero_grupos: @categorium.numero_grupos, numero_jugadores: @categorium.numero_jugadores, numero_jugadores_grupo: @categorium.numero_jugadores_grupo, tipo: @categorium.tipo, torneo_id: @categorium.torneo_id } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { nombre: @categorium.nombre, numero_grupos: @categorium.numero_grupos, numero_jugadores: @categorium.numero_jugadores, numero_jugadores_grupo: @categorium.numero_jugadores_grupo, tipo: @categorium.tipo, torneo_id: @categorium.torneo_id } }
