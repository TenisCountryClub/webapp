...
class TorneosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create torneo" do
    assert_difference('Torneo.count') do
      post torneos_url, params: { torneo: { fechaFin: @torneo.fechaFin, fechaInicio: @torneo.fechaInicio, nombre: @torneo.nombre, tipo: @torneo.tipo } }
    end
  ...
  test "should update torneo" do
    patch torneo_url(@torneo), params: { torneo: { fechaFin: @torneo.fechaFin, fechaInicio: @torneo.fechaInicio, nombre: @torneo.nombre, tipo: @torneo.tipo } }
